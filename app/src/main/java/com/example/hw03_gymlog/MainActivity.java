...
public class MainActivity extends AppCompatActivity {
    ...
    static final String SAVED_INSTANCE_STATE_USERID_KEY = "com.example.hw03_gymlog.SAVED_INSTANCE_STATE_USERID_KEY";
    ...
    public static final String TAG = "TSF_GYMLOG";
    String mExercise = "";
    double mWeight = 0.0;
    int mReps = 0;
